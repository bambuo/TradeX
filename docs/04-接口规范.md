...
{
    Task<BacktestTask> StartBacktestAsync(Guid deploymentId, Guid strategyId, Guid exchangeId, string pair, string timeframe, DateTime startAt, DateTime endAt, decimal initialCapital = 1000m, CancellationToken ct = default);
